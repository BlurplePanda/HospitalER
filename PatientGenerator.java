...
public class PatientGenerator {
    ...
    public static void setArrivalInterval(double v) {
        arrivalInterval = (int) v;
    }

    public static int getProbPri1() {
        return (int) (probPri1 * 100);
    }

    public static void setProbPri1(double v) {
        probPri1 = v / 100;
    }

    public static int getProbPri2() {
        return (int) (probPri2 * 100);
    }

    public static void setProbPri2(double v) {
        probPri2 = v / 100;
    }

    public static int getProbMRI() {
        return (int) (probMRI * 100);
    }

    public static void setProbMRI(double v) {
        probMRI = v / 100;
    }

    public static int getProbSurgery() {
        return (int) (probSurgery * 100);
    }

    public static void setProbSurgery(double v) {
        probSurgery = v / 100;
    }

    public static int getProbXRay() {
        return (int) (probXRay * 100);
    }

    public static void setProbXRay(double v) {
        probXRay = v / 100;
    }

    public static int getProbUltraSound() {
        return (int) (probUltraSound * 100);
    }

    public static void setProbUltraSound(double v) {
        probUltraSound = v / 100;
    }
    ...
    private static Queue<Treatment> GenerateRandomTreatments(int priority) {
        ...
        for (int i = random.nextInt(5); i >= 0; i--) {    // up to 5 more treatments
            do { // ensure that department is not the same as the previous department.
                ...
                if (num < probMRI) {
                    newTreatment = new Treatment("MRI", GenerateTime(200));
                } else if (num < probSurgery) {
                    newTreatment = new Treatment("Surgery", GenerateTime(200));
                } else if (num < probXRay) {
                    newTreatment = new Treatment("X-Ray", GenerateTime(20));
                } else if (num < probUltraSound) {
                    newTreatment = new Treatment("UltraSound", GenerateTime(20));
                } else {
                    newTreatment = new Treatment("ER", GenerateTime(10));
                }
